...
export const faqData: FAQItem[] = [
    {
        question: "What is industrial shrink wrap and how does it work?",
    ...
    {
        question: "How long does shrink wrap last on a building or structure?",
        answer: "Our industrial-grade shrink wrap is UV-resistant and designed to last 12-18 months under normal British Columbia weather conditions. For projects requiring longer protection, we offer maintenance services and can re-wrap as needed. The wrap remains intact through Vancouver's harsh winters, including heavy snow loads and high winds."
    },
    {
        question: "What types of projects can Vancouver Shrink Wrap handle?",
    ...
    },
    {
        ...
        answer: "Cost depends on the size and complexity of your project. Factors include square footage, height, accessibility, and whether scaffolding is needed. We provide free on-site estimates for accurate pricing. Generally, shrink wrapping is more cost-effective than project delays caused by weatherâ€”most clients see immediate ROI through reduced downtime."
    },
    {
        question: "Do you service areas outside of Vancouver?",
        answer: "Yes! While we're based in Vancouver, we serve all of British Columbia including St. Albert, Sherwood Park, Leduc, Fort Saskatchewan, Calgary, Red Deer, Grande Prairie, and Fort McMurray. We regularly travel for larger industrial and commercial projects throughout the province."
    },
    {
    ...
    },
    {
        ...
        answer: "Our shrink wrap is 100% recyclable. After removal, the material can be recycled through standard polyethylene recycling programs. Additionally, by providing superior containment, we help prevent paint fumes, dust, and debris from escaping into the environmentâ€”helping your project meet environmental compliance requirements."
    },
    {
    ...
    {
        question: "What's the difference between shrink wrap and regular tarps?",
        answer: "Tarps are loose coverings that flap in wind, leak at seams, and provide minimal insulation. Shrink wrap is heat-welded to create a seamless, structural membrane that's completely waterproof, wind-resistant, and provides thermal insulation. Shrink wrap won't tear or come loose in British Columbia's harsh winter conditions, making it the professional choice for serious weather protection."
    },
    {
        question: "Are you licensed and insured?",
        answer: "Yes, Vancouver Shrink Wrap is fully insured and WCB compliant. We carry comprehensive liability insurance and workers' compensation coverage for all our team members. We can provide certificates of insurance upon request for your project requirements."
    }
];
