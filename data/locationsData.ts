...
export const locations: Location[] = [
    ...
    { id: 'hudsons-hope', name: 'Hudsonâ€™s Hope', region: 'Northern British Columbia', industrialSites: ['Local Industrial Area'], description: 'Professional shrink wrap services in Hudsonâ€™s Hope.' },
